namespace MVVM_RecipeHandler_EF6._0.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MVVM_RecipeHandler_EF6._0.RecipeContext>
    {
        ...
        protected override void Seed(MVVM_RecipeHandler_EF6._0.RecipeContext context)
        {
            ...
            string ImageString = BuildImgString("../../MVVM_RecipeHandler/Images/double_cheese.jpg");
            ...
            RecipeSeed.Add(new Recipe("Eierspeis", "Pfanne auf mittlere bis hohe Hitze aufdrehen, Öl hinzufügen. Eier aufschlagen und mit einer Gabel verquirlen. Bis zum gewünschten Gargrad kochen (10 Sekunden bis 1 Mintue) und mit Salz Pfeffer und Schnittlauch servieren", 2, ImageString) );
